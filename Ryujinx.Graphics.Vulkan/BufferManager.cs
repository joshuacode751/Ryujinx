...
namespace Ryujinx.Graphics.Vulkan
{
    class BufferManager : IDisposable
    {
        ...
        public unsafe BufferHolder Create(VulkanRenderer gd, int size, bool forConditionalRendering = false, BufferAllocationType baseType = BufferAllocationType.HostMapped, BufferHandle storageHint = default, bool deviceLocal = false)
        {
